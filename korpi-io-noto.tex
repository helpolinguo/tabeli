% korpi-io-noto.tex — le pas des pages qui portent une note.
%
% ECRIT A LA MAIN, page par page. Voir preambule.tex, section 8 : le pas
% de korpi-io.tex a ete regle pour que la matiere REMPLISSE le bloc, et
