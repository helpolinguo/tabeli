...
gravuri.py — prepare les tableaux muraux pour la page de lecture.
    ...
    python3 tools/gravuri.py t01-apar-1 plates/font/page1.pdf
    python3 tools/gravuri.py t02-tit-0  plates/font/page2.pdf
    python3 tools/gravuri.py --tuto          # ce que fait l'outil, en detail
...
couches a part dans plates/kovri/ avant de les composer.
...
bien mieux une fois la couleur dessous. On compose donc ici.
    ...
    plates/font/     les PDF d'origine (non versionnes : ~100 Mo)
    plates/kovri/    les deux couches extraites (non versionnees)
    plates/          les deux WebP par tableau (VERSIONNES, ~1 Mo)
"""
import io
import json
import sys
