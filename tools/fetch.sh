...
#
#  USAGE
#      sh tools/telesargo.sh                 # les 32, dans originals/
#      sh tools/telesargo.sh originali tabeli    # les 16 planches d'abord
#      sh tools/telesargo.sh originali vortari   # les 16 vocabulaires
#      sh tools/telesargo.sh originali tout 30   # en patientant plus
# ===================================================================
