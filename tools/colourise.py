...
#
#  USAGE
#      python3 tools/kolorigo.py t14-apar-1 originals/t14col.pdf
#      python3 tools/kolorigo.py t14-apar-1 originals/t14col.pdf --essai
#
#  « --essai » ne sert rien : il ecrit dans plates/review/ une bande
