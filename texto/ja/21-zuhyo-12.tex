...
%%K t12-06-1 p
6. --- 早く来ていたので、駅の旅客の行き来を見る暇があった。ある者は
...
\textsuperscript{(36)} は急行で、駅に長くは止まらないからである。

%%K t12-09-1 p
9. --- それから出発の\VUgras{ホーム}へ行き、乗り換えずにすむ直通の
\VUgras{車輌} \textsuperscript{(37)} を探した。廊下のついた車に乗った。中には
たばこを吸う\VUgras{仕切} \textsuperscript{(38)} があり、もう一つは「婦人だけ」に
取ってある。
...
\textsuperscript{(39)} を閉め、\VUgras{窓のカーテン} \textsuperscript{(41)} を巻き上げ、
...
\VUgras{ホーム} \textsuperscript{(65)} は尽き、\VUgras{トイレ} \textsuperscript{(66)} の
...
%%K t12-15-1 p
15. --- 次に\VUgras{貨物の駅} \textsuperscript{(71)} が目の前を過ぎた。覆屋の
...
立っていた。\VUgras{信号機} \textsuperscript{(86)} も後にし、駅は遠くに消えた。
...
%%K t12-20-1 p
20. --- 税関の者が検めているあいだ、私は欠伸をしながら駅の壁を飾る
