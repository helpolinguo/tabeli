...
幅広のビロードのズボンをはいた職人が大工である。一人は小さな梁を支え、もう一人は
...
\VUgras{スレート} \textsuperscript{(32)} であり、ベランダの屋根は\VUgras{亜鉛}
...
塗る。いまは\VUgras{ベランダ} \textsuperscript{(33)} の天井をやっている。左官と同じく
...
のぼって\VUgras{テラス} \textsuperscript{(28)} のところにおり、\VUgras{日除}
\textsuperscript{(29)} を取りつけている。

%%K t05-01-39 p
大きな窓のそばにいる職人は\VUgras{ガラス屋} \textsuperscript{(96)} である。
\VUgras{ガラス} \textsuperscript{(18)} を\VUgras{パテ} \textsuperscript{(73)} ではめて
...
%%K t05-01-49 p
まず\VUgras{一階} \textsuperscript{(7)} に入ろう。これが\VUgras{呼び鈴}の押しボタン
...
\VUgras{書斎} \textsuperscript{(f)} である。\VUgras{ベランダ} \textsuperscript{(23)} は
客間の隣で、\VUgras{ガラス戸} \textsuperscript{(25)} がついている。
...
%%K t05-01-53 p
階段の向いが\VUgras{トイレ} \textsuperscript{(20)} と\VUgras{化粧室}
...
\VUgras{子供部屋} \textsuperscript{(k)} である。広い\VUgras{テラス}
\textsuperscript{(21)} に通じている。そのテラスの下にもう一つトイレ
