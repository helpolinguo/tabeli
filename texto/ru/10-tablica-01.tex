...
%  Дельмаса ».
%
%  QUATRE MOTS SEULEMENT, ET C'EST LA MESURE QUI LE DIT. Le balayage
%  de registre de 2026 cherchait dans cette colonne le litteraire du
%  russe : « ибо », « весьма », « сей », « дабы ». Il en a trouve
%  quatre — deux « ибо » et deux « весьма » — la ou l'espagnol avait
%  vingt-deux calques et le japonais cent seize. « сей » et « дабы » :
%  zero. Le releveur russe avait deja ecrit en russe d'aujourd'hui.
%
%  Et l'un des deux « ибо » etait au bloc t04-c2-05-1 — celui que
%  l'anglais avait rendu par « for », le suedois par « ty », le
%  tcheque par « nebot ». La phrase de depart designe elle-meme
%  l'endroit ou l'on trebuche, quelle que soit la langue d'arrivee.
%  « Ochen kholodno, ibo prishla zima » devient « Ochen kholodno :
%  prishla zima », ou le deux-points fait le travail de la
%  conjonction, comme en russe courant.
%
%  « потому что » revient vingt-six fois et « так как » dix : le
%  russe de cette colonne avait donc DEJA ses deux conjonctions
%  usuelles, et les deux « ибо » n'etaient pas un systeme, seulement
%  deux echappees.
%
...
\VUgras{окно} с двумя \VUgras{форточками} \textsuperscript{(78)} и \VUgras{застеклённая
