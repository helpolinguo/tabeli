...
%%K t01-05-2 p
Dit klaslokaal is niet koud. In het midden staat om het te verwarmen een zeer goede
...
kameraad, vriendelijk en behulpzaam. Hij is zeer oplettend.
...
\VUgras{schriftenmap} \textsuperscript{(33)} is gescheurd, want hij is zeer slordig. Waarom
brengt hij zijn
...
%%K t01-12-1 p
12. --- De leerlingen van de tweede bank, links van de onderwijzer, zijn zeer jong. De eerste,
...
werkt goed, maar zijn \VUgras{kleding} is zeer verwaarloosd.
...
\VUgras{leraar} \textsuperscript{(60)} is zeer geduldig, hij verbetert de \VUgras{tekeningen}
