...
%  le relatif est bien la, mais 54 caracteres separent les deux
...
%  le nombre de lignes a lire, lui, passe de 55 a 88 sur le lot
%  temoin. La liste fait gagner du temps, pas de la certitude :
%  c'est renvoji.py qui tranche, et il a tranche — zero divergence.
% ===================================================================
