...
skraido aplink \VUgras{varpinės} \textsuperscript{(5)} \VUgras{smailę}
\textsuperscript{(7)}, vainikuojančią kaimo \VUgras{bažnyčią} \textsuperscript{(6)}.
...
%%K t03-c1-10-1 p
10. --- Tuo tarpu \VUgras{avilio} \textsuperscript{(21)} mažosios \VUgras{bitutės}
\textsuperscript{(22)} zvimbdamos eina ten grobio rinkti savo saldaus
\VUgras{medaus.}
