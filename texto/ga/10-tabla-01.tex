...
%
%  CELA COUTE MOINS QU'ON NE CROIT, MAIS CELA COUTE. L'irlandais
%  postpose son complement du nom comme l'ido — « doras an chaisleáin »,
%  la porte du chateau — de sorte que la source ordinaire des
%  inversions, celle qui a coute vingt-neuf tours au basque, ne joue
%  pas ici. Mais le VSO place le SUJET avant l'OBJET la ou l'ido, dans
%  une phrase passive, place l'objet avant : le tableau 7 en donnera un
%  cas, et il se defait par le « briathar saor », le verbe autonome,
%  qui rend l'ordre de l'ido. Voir le message de commit du tableau 7.
%
...
leathan le dhá \VUgras{fhuinneog aerála} \textsuperscript{(78)} agus \VUgras{doras
