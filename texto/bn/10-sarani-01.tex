% ===================================================================
%  সারণি নং ১ — বিদ্যালয়। — মাধ্যমিক বিদ্যালয়। — শ্রেণিকক্ষ।
%
...
%  phrase autour.
%
%  LES CHIFFRES DES RENVOIS RESTENT ARABES, car ils numerotent la
%  gravure et doivent se lire d'une colonne a l'autre ; seuls les
%  nombres du texte courant s'ecrivent en toutes lettres.
% ===================================================================
...
\VUcentre{8.4pt}{160}{—}
\VUsaut{2.6mm}
\VUtitre{15.6pt}{0}{দেলমা সহায়ক সারণিসমূহের}
\VUsaut{3.4mm}
\VUornamento{9pt}
\VUsaut{5.0mm}
...
%%K t01-01-1 p
১। --- এই সারণিতে একটি মাধ্যমিক বিদ্যালয়ের \VUgras{শ্রেণিকক্ষ} দেখানো
...
%%K t01-02-1 p
২। --- মঞ্চের বাঁ দিকে কাচের দরজাওয়ালা একটি \VUgras{আলমারি}
...
%%K t01-03-1 p
৩। --- সব ছাত্র নিজের \VUgras{জায়গায়} \textsuperscript{(17)} নেই। জন
...
%%K t01-04-1 p
৪। --- \VUgras{এই} শিক্ষক \VUgras{আধুনিক ভাষার} শিক্ষক। তিনি ছাত্রদের
বিদেশি ভাষা \VUgras{(জার্মান, ইংরেজি, স্প্যানিশ, ইতালীয়, রুশ} বা
\VUgras{ফরাসি)} বলতে, পড়তে ও লিখতে শেখান।

%%K t01-05-1 p
৫। --- শ্রেণিকক্ষটি খুব প্রশস্ত ও খুব আলোকিত। শেষ দিকে দুটি
...
%%K t01-06-1 p
৬। --- \VUgras{ঘড়িতে} \textsuperscript{(63)} নটা বেজে পাঁচ মিনিট।
...
%%K t01-07-1 p
৭। --- উঠানে আরও কয়েকজনকে দেখা যায়: \VUgras{পরিদর্শক}
...
%%K t01-08-1 p
৮। --- উঠানের শেষে \VUgras{ব্যায়ামের সরঞ্জাম} \textsuperscript{(70)} ও
...
%%K t01-09-1 p
৯। --- মঞ্চের ডান দিকের প্রথম বেঞ্চের ছাত্রেরা হল \VUgras{হেনরি} (*),
...
%%K t01-10-1 p
১০। --- পাশের টেবিলে আছে \VUgras{লুই, অ্যান্টনি} ও \VUgras{পল}। লুই তার
...
%%K t01-11-1 p
১১। --- হেনরির পিছনে \VUgras{জর্জ} \textsuperscript{(38)}। সে খারাপ ছেলে নয়,
...
%%K t01-12-1 p
১২। --- শিক্ষকের বাঁ দিকের দ্বিতীয় বেঞ্চের ছাত্রেরা খুব ছোট। প্রথমজন,
...
%%K t01-13-1 p
১৩। --- তাদের পিছনে তিনজন \VUgras{অলস}। \VUgras{আলবার্ট} পড়া মুখস্থ করে
...
%%K t01-14-1 p
১৪। --- তার পাশের ছাত্রেরা অবশ্য ভালো আচরণ করে। \VUgras{আর্নেস্ট}
...
%%K t01-15-1 p
১৫। --- \VUgras{অঙ্কনকক্ষে} দেয়ালে সুন্দর \VUgras{নমুনা} ঝুলছে এবং ছাদ
...
%%K t01-16-1 p
১৬। --- \VUgras{সংগীতকক্ষটি} খুব কৌতূহলজনক মনে হয়। সেখানে
...
%%K t01-17-1 p
১৭। --- \VUgras{হাতের কাজের} \VUgras{কর্মশালার} \textsuperscript{(69)} এক কোণ
...
%%K t01-18-1 p
১৮। --- গণিতের শিক্ষক ছাত্রদের \VUgras{জ্যামিতি,} \VUgras{পাটিগণিত,
...
%%K t01-19-1 p
১৯। --- মেট্রিক পদ্ধতির চিত্রে চোখে পড়ে: একটি \VUgras{মিটার}
