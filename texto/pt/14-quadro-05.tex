...
%%K t05-01-49 p
Entremos no \VUgras{rés do chão} \textsuperscript{(7)}. Eis o botão da
...
O \VUgras{corredor} \textsuperscript{(a)} está ao fundo. À direita, eis a
...
\textsuperscript{(15)} e conta os degraus. São catorze. Eis o \VUgras{patamar}
...
retrete \textsuperscript{(20)} e, contra a parede, eis o \VUgras{sino}
