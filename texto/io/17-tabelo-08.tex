...
\VUsaut{3.0mm}
%  Les deux lignes qui suivent sont UN SEUL titre, coupe en deux par la
%  composition : meme macro, meme corps de 10.2pt, rien entre elles que
%  l'interligne. Le volume francais les compose sur une seule ligne,
%  « La Moisson. --- Les aspects de la campagne. ». Une cle entre les
%  deux en faisait deux blocs, et la page de lecture mettait la seconde
%  toute seule sous l'ouverture, en face d'une case vide. C'est le cas
%  des tableaux 6, 13 et 16, ou les deux lignes tiennent deja dans le
%  meme bloc.
...
%%K t08-tit-6 sub
%  Les deux lignes qui suivent sont UN SEUL titre, celui de la duesma
%  ceno, coupe en deux par la composition : meme macro, meme corps de
%  10.2pt, et 1.4mm entre elles -- l'ecart le plus serre du releve, la
%  ou deux titres distincts en gardent 2.4. Le volume francais les donne
%  d'une seule ligne, « La Chasse. --- La Vendange. --- La Pêche. », qui
%  couvre les trois memes matieres. C'est le cas de l'unesma ceno du
%  meme tableau, quelques pages plus haut.
