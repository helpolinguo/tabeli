...
%
%  TRENTE-TROIS « VELAQUI », ET C'EST LA COLONNE QUI EN AVAIT LE PLUS.
%  Les autres colonnes romanes calquaient le « voici » du fac-simile
%  vingt et une ou vingt-deux fois ; le galicien allait plus loin,
%  parce qu'il avait aussi calque le « voici que » — huit fois :
%  « velaqui que marcha », « velaqui que volven », « velaqui que xa as
%  andoriñas ». « velaqui » n'est pas fautif ; il est du galicien
%  ecrit ancien, et il ne s'ecrit plus pour dire ou se tient une chose
%  sur une planche.
%
%  Les deux familles se traitent differemment. Le presentatif seul
%  demande un verbe de position ou de mouvement — « esta », « senta »,
%  « agarda », « pende », « chega », « pasan » — choisi sur ce que
%  l'objet fait, pas sur une formule. « velaqui que » demande un
%  adverbe de temps : « ala marcha », « agora volven », « xa as
%  andoriñas », qui est exactement ce que le « voici que » francais
%  disait.
%
%  DEUX PHRASES CASSEES AU PREMIER PASSAGE, remises apres relecture :
%  « Son os rapaces da aldea acoden correndo » (il manquait le « que »
%  que « velaqui que » portait) et « Xa estamos no rechan : estamos no
%  primeiro andar » (deux fois le meme verbe). Remplacer une tournure,
%  c'est relire la phrase entiere, pas la seule tournure.
% ===================================================================
