...
%%K t03-c1-03-1 p
3. --- \VUgras{Ağaçlarda} daha \VUgras{yaprak} yok denecek kadar azdır. İnce
\VUgras{kavakta} \textsuperscript{(3)} ve yüksek \VUgras{çınarda}
\textsuperscript{(17)} şimdilik yalnız tomurcuk vardır.

%%K t03-c1-04-1 p
4. --- \VUgras{Kırlangıçlar} \textsuperscript{(4)} dönmüştür, ve seve seve
cıvıldayarak şu \VUgras{külahın} \textsuperscript{(7)} çevresinde dönüyorlar,
ki o külah \VUgras{çan kulesinindir} \textsuperscript{(5)}; o kule de köyün
...
\VUgras{saatiyle} \textsuperscript{(8)}, pek yalındır. \VUgras{Küçük ibre}
\textsuperscript{(9)} X sayısındadır : \VUgras{saatleri} gösterir.
\VUgras{Büyüğü} \textsuperscript{(10)} XII (öğle) üstündedir; \VUgras{dakikaları}
gösterir.
...
%%K t03-c1-07-1 p
7. --- Kilisenin yalnız büyük \VUgras{kapısı} \textsuperscript{(13)} yoktur,
yanda küçük bir kapısı da vardır. \VUgras{Papaz} \textsuperscript{(15)},
...
%%K t03-c1-09-1 p
9. --- Usta Aliboron (eşek) bu sabah gezisinden pek hoşnuttur. Yandaki
...
\VUgras{kayısı ağaçları} \textsuperscript{(19)} bütün bütün pembe ve beyazdır,
...
\VUgras{vaftizinden} sonra kiliseden çıkan alaydır.
...
\VUgras{gömleği} \textsuperscript{(32)} vardır.

%%K t03-c1-14-1 p
14. --- Ne kadar sevinçlidir! Sevdiği çiçekleri unutuyor —
...
\VUgras{saksılardadır} \textsuperscript{(38)}, ve o saksılar
\VUgras{duvarın} \textsuperscript{(33)} üstündedir, bir de öyle güzel bir çit
...
%%K t03-c1-16-1 p
16. --- Bir başkası \VUgras{köpeğin} \textsuperscript{(42)} pençesini ezmiştir;
...
uzun kurdeleli güzel bir \VUgras{başlık} \textsuperscript{(46)} vardır.
\VUgras{Yeni doğanı} \textsuperscript{(47)} taşıyor, ki baştan aşağı
\VUgras{danteller} \textsuperscript{(48)} içinde sarılıdır.
...
\textsuperscript{(50)} vardır. Vaftiz anası elinde güzel bir \VUgras{buket}
...
\VUgras{redingot} \textsuperscript{(57)} ile beyaz bir yelek vardır. Sonra
...
yürüyor. Bir \VUgras{akrabaya} \textsuperscript{(64)} kolunu vermiştir. Ailenin
...
%%K t03-c1-22-1 p
22. --- Öte yanda pek \VUgras{kibar} \textsuperscript{(68)} bir oğlan vardır.
Şapkasını kaldırıp tanıdıklarına \VUgras{« günaydın »} diyor.

%%K t03-c1-23-1 p
23. --- Köylüler vaftiz alayının geçişini görmek için evlerinden çıkmıştır.
...
%%K t03-c2-01-1 p
1. --- \VUgras{Yaz} gelmiştir. \VUgras{Haziran} (Temmuz veya \VUgras{Ağustos})
...
bağlarını (düğmelerini) çözüyor. İki arkadaşı çoktan hazırdır. Üstlerinde
yalnız \VUgras{fanilaları} \textsuperscript{(2)} ile \VUgras{mayoları}
\textsuperscript{(3)} vardır. Arkadaşlarını beklerken konuşuyorlar. Öteki
...
%%K t03-c2-05-1 p
5. --- Bir delikanlı \VUgras{ceketini} \textsuperscript{(10)} özenle katlamıştır.
Onu bir havluya koyuyor; yanındaki biraz sonra o havluya ikisinin de
\VUgras{takımlarını} bağlayacak.

%%K t03-c2-06-1 p
6. --- Altıncı oğlan geri kalmıştır. Başında hâlâ \VUgras{kasketi}
\textsuperscript{(11)} vardır. Ne \VUgras{gömleğini} \textsuperscript{(12)}
çıkarmıştır, ne \VUgras{yakasını} \textsuperscript{(13)}, ne de
...
üstündedir. Gelecek yarışa besbelli hazır olamayacak.
...
\textsuperscript{(21)} çıkmıştır. Pek heyecanlı olan yarışı seyrediyorlar. Her
...
\textsuperscript{(30)} suya düşmüştür. Yüzerek kıyıya dönüyor.
...
vardır. İnsanlar türlü türlü \VUgras{çadırları} görmeye geliyor :
\VUgras{atlıkarınca} \textsuperscript{(40)}, \VUgras{sirk}
\textsuperscript{(41)}, ki orada gösteri başlamıştır bile; \VUgras{halk balosu}
...
\VUgras{devin} \textsuperscript{(48)} ve \VUgras{cücenin} çadırı vardır.
Birincisinin \VUgras{boyu} iki metre on beştir; ikincisi bir çocuk kadar
bile uzun değildir.

%%K t03-c2-15-1 p
15. --- Sonunda işte büyük \VUgras{hayvan arabası} \textsuperscript{(50)},
\VUgras{yabanıl hayvanlarıyla} — \VUgras{pençeleri} pek güçlü olan
