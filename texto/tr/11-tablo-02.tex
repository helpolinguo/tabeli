...
%%K t02-01-1 p
1. --- İnsan vücudunun başlıca bölümleri şunlardır: \VUgras{baş},
...
%%K t02-02-1 p
2. --- Başın iki bölümü vardır: içinde \VUgras{beynin} bulunduğu ve
...
%%K t02-04-1 p
4. --- Önce şu \VUgras{alın} vardır; güçlü bir zekâyı ve durmadan işleyen bir
kafayı belli eder. \VUgras{Şakaklar} çok açıktır. \VUgras{Göz} canlı ve ardına
kadar açıktır. Sık bir \VUgras{kaş} ile uzun \VUgras{kirpikler} onu korur.

%%K t02-05-1 p
5. --- Burada \VUgras{burun} ile \VUgras{burun delikleri} de vardır. Burunla
...
uzuvlarıdır: \VUgras{görme}, \VUgras{işitme}, \VUgras{koklama},
\VUgras{tatma} ve \VUgras{dokunma}.

%%K t02-08-1 p
8. --- Böylece baş, insan vücudunun en ilgi çekici bölümlerinden biridir.
...
aldığımız \VUgras{akciğerler} ile yaşamın merkezi olan \VUgras{yürek} vardır.
...
\VUgras{omuzlar} ve \VUgras{karındır} (göbek). Uyumak için yan yatar ya da
sırtüstü uzanırız, yükü de omuzda taşırız.

%%K t02-13-1 p
13. --- Karında \VUgras{mide} ile \VUgras{bağırsaklar} vardır. Yemeğimizi
...
%%K t02-14-1 p
14. --- Dört \VUgras{uzvumuz} vardır: iki \VUgras{kol} ile iki
...
başlı kas, kolu oynatır; \VUgras{dirsek} de onu \VUgras{ön kola} bağlar.
...
%%K t02-16-1 p
16. --- Bacağın bölümleri şunlardır: \VUgras{uyluk}, \VUgras{diz} ile
\VUgras{diz ardı}, \VUgras{etinin} \VUgras{deriyle} örtülü olduğu
\VUgras{baldır}, \VUgras{ayak bileği} ve \VUgras{ayak}. Bacağın
\VUgras{kemikleri} pek kalın ve pek sağlamdır. Ayağın ucunda \VUgras{ayak
parmakları} vardır. Öteki bölümleri \VUgras{taban} ile \VUgras{ökçedir}.

%%K t02-17-1 p
17. --- İnsan vücudunun aşağı yukarı bütün açıklaması budur.

%%K t02-17-2 p
\textit{Not.} --- \textit{« ...\,m ağrıyor (başım, vb.) » cümlesinin yardımıyla
öğretmenler bütün bu sözleri iyi ya da kötü} \VUgras{beden sağlığı}
\textit{bakımından yeniden gözden geçirebileceklerdir.}
...
%%K t02-noto-1 noto
\VUnotes{143.2mm}{%
(*) Çocuk oyunlarının adları çoğu kez büsbütün ulusaldır. Onlara idoda
...
\VUgras{kurbağa oyunu} \textsuperscript{(20)} (ingilizce) aynıdır; oyuncular
...
şudur: başın üstünden atlamak için oyuncular ellerini arkadaşlarının
...
%%K t02-26-1 p
26. --- Alanın ortasında iki ağaç vardır. Bunlardan birinin altında yedi sekiz
oğlan \VUgras{omuz atlaması} \textsuperscript{(30)} (*) oyununu kurmuştur. Bu
...
%%K t02-27-1 p
27. --- \VUgras{Körebe} \textsuperscript{(31)} de pek eğlencelidir; kızlarla
...
\textsuperscript{(34)} de, çok daha gürültülüdür.

%%K t02-29-1 p
29. --- Bu son oyun büyük öğrencilerin sevincidir. Öğretmenlerimiz bile onu
...
sevincidir. Bana eski oyunumuz \VUgras{esir almaca} \textsuperscript{(38)} daha
...
%%K t02-34-1 p
34. --- Daha pek çok oyun vardır, ama onları saya saya hiç bitiremem, ve bu
...
bölümü kolayca tamamlayabileceklerdir.}
\VUsaut{6.0mm}
\VUfilet{22mm}
