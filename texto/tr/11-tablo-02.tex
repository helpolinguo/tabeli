...
\VUgras{kemikleri} çok kalın ve çok sağlam. Ayağın ucunda \VUgras{ayak
...
kimi zaman da çok yanıltıcı olmadıkça şu ya da bu ülkenin adını alarak.
...
%%K t02-27-1 p
27. --- \VUgras{Körebe} \textsuperscript{(31)} de çok eğlenceli; kızlarla
oğlanlar sırayla gözlerini \VUgras{bağlar} ve yakalanmaya bırakan
beceriksizleri yakalarlar.

%%K t02-28-1 p
28. --- Alanın ortasında, işte biraz kaba olsa da çok fransız bir oyun:
...
seve seve benimser. Çok beceri ile çeviklik ister, ve bana çok hoş gelir.
