...
%%K t08-noto-1 noto
\VUnotes{143.2mm}{%
\textit{(*) Çünkü bu söz belirsizdir : keten hasadı mı? üzüm mü? elma mı?
Belki daha iyi olur ki «} \VUgras{mesono} \textit{» kullanılsın, ki} Mondo
\textit{XIV, s. 242'de önerilmiştir. Ama şimdiye dek o yeni kökü akademi
benimsememiştir ve ido hareketinin genel kurallarına göre tartışılmayı
beklemektedir.}%
}
...
%%K t08-c1-01-1 p
1. --- \VUgras{Yazla} birlikte kırlar bir kez daha görünüşünü değiştirmiştir.
...
%%K t08-c1-02-1 p
2. --- \VUgras{Kır çiçekleri} açmıştır. \VUgras{Peygamber çiçekleri}
...
%%K t08-c1-03-1 p
3. --- Meyve ağaçları yaprak vermiştir; meyveler olmuştur. Küçük
\VUgras{kiraz ağacı} \textsuperscript{(4)} güzel \VUgras{kirazlarla}
\textsuperscript{(5)} yüklüdür; çocuklar onları koparır ve iştahla yer.
...
\textsuperscript{(7)} ve güzel \VUgras{koçlar} \textsuperscript{(8)} olmuştur,
...
benzemez. Tek kaygısı ufuktan geçen fırtınadır, ve \VUgras{sürü çobanı}
\textsuperscript{(13)}, ki \VUgras{sürahisini} \textsuperscript{(14)}
dudaklarına kaldırmıştır, ondan da kaygısız görünür.

%%K t08-c1-06-1 p
6. --- Sıcak boğucudur; çünkü \VUgras{köpek} \textsuperscript{(15)} de
...
%%K t08-c1-08-1 p
8. --- Kır çocukları için buğdayın biçilmesi büyük eğlence vaktidir.
...
\textsuperscript{(30)} iyice bilenmiştir, çocuklar buğdayı devşirip \VUgras{demetler} \textsuperscript{(31)} ya
...
vardır. Herkes hasadın
başındadır. Ama yoksullar yalnız eski aletleri kullanırken ---
...
giymiştir, ve deriden \VUgras{tozlukları}, ki \VUgras{karakurbağalarının}
...
\textsuperscript{(10)} almıştır, ve yürümüştür.
...
otu} \textsuperscript{(30)} dalı tırmanır. Burada yalnız bir süs bitkisidir,
ama asmanın pek az yetiştiği kimi ülkelerde \VUgras{bira} yapmak için şerbetçi
otu yetiştirilir.

%%K t08-c2-07-1 p
7. --- Küçük \VUgras{elma ağacı} \textsuperscript{(33)} elmalarla yüklüdür, ki
...
\textsuperscript{(40)} sıraları dizilidir, ki \VUgras{salkımlarla} yüklü
görkemli \VUgras{asma kütüklerini} \textsuperscript{(39)} tutar.

%%K t08-c2-08-2 p
Bütün yıl \VUgras{bağcı} \textsuperscript{(42)} \VUgras{bağına}
\textsuperscript{(38)} bakmak için emek vermiştir, ve şimdi iyi bir hasatla
...
tekneleri dolduruyor, ve herkes sevinçlidir.
...
%%K t08-c2-09-1 p
9. --- Aynı şey \VUgras{oltacılar} \textsuperscript{(44)} için de doğrudur; tan
...
%%K t08-c2-10-1 p
10. --- Sonbahar güzel gezinti mevsimidir : yaya, \VUgras{at}
...
ülkelere uçmak için şimdiden damlarda toplanmaya başlamıştır. Yaşlı
