...
birinci sınıf bir \VUgras{liman} \textsuperscript{(1)}. Yanından akan ırmak
dört yüz metre geniştir ve çok güzel bir demirleme yeri yapar.
...
\textsuperscript{(9)} var; onlar da şimdi \VUgras{hapishane} olarak
kullanılır.

%%K t11-c1-04-1 p
4. --- Çok eski görünen bütün bu \VUgras{mahallede} yalnız bir yapı görece
yeni: \VUgras{gümrük binası} \textsuperscript{(10)}. Rıhtımla o küçük
...
\VUgras{yükselir}: \VUgras{ticaret odası} \textsuperscript{(14)}. Bir yüzü
küçük bir alana açılır, ki orada \VUgras{valilik} \textsuperscript{(15)}
bulunur. Şehrimiz, gerçekten, başkent olmasa da önemli bir il merkezi.
...
%%K t11-c1-06-1 p
6. --- Epeyce büyük olan garnizon, geniş ve çok sağlıklı \VUgras{kışlalarda}
...
\textsuperscript{(26)} var. Bu \VUgras{alan} çok büyük değil, ama şehrin
...
şehirlimizin anısına dikilmiş bir anıt.
...
lambaları} \textsuperscript{(29)} var. Ama \VUgras{yerel gazeteler} o
...
\VUgras{elektrikli tramvaylar} \textsuperscript{(31)} gelmiş, ki pek
\VUgras{ucuz} bir ücretle yolcuları \VUgras{şehrin} bir ucundan
\VUgras{ötekine} tez ulaştırır.

%%K t11-c1-10-1 p
10. --- Adliyenin yanında \VUgras{banka} \textsuperscript{(32)} var, ki
...
%%K t11-c1-11-1 p
11. --- Yanındaki o güzel yapı \VUgras{müze}. İçinde bir arada şehrin
...
\VUgras{resim galerisi} \textsuperscript{(36)} var, ki görkemli bir sürekli
\VUgras{sergi} yapar.
...
\textsuperscript{(40)}, ki \VUgras{hastanenin} \textsuperscript{(39)}, ile
o
...
\VUgras{postane} \textsuperscript{(43)} var, ki bir \VUgras{özel eve}
\textsuperscript{(42)} yerleşmiş.
...
\textsuperscript{(47)} toplanmış. \VUgras{Posta memurları}
...
tramvayını durdurmak zorunda kalmış, şehrin bir \VUgras{cankurtaranı}
...
\textsuperscript{(55)} yanına getirilmiş.

%%K t11-c2-02-1 p
2. --- Talimden dönen bir piyade bölüğü durmuş, at üstündeki
...
geri itebiliyorlar. Jandarmalar zaten çok meşgul. İçlerinden biri
...
\textsuperscript{(68)} kurdurmuş, ki uzun \VUgras{hortumu}
...
kurulmuş. İtfaiyecilerin, kara \VUgras{duman} \textsuperscript{(75)}
...
\VUgras{orkestranın} \textsuperscript{(80)}, çalgılarını taşıyarak:
...
\VUgras{giysileriyle} \textsuperscript{(90)} kaçmak zorunda kalmış. Baş
