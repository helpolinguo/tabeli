...
%%K t06-apar-2 apar
Ev bitmiş. Jan'ın amcası, düzenini bildiğimiz yeni evine yerleşmiş.
...
taranmaya ve hazırlanmaya yarayan şeyler şurada burada durur. Şunlar:
...
şilte} \textsuperscript{(21)} var; Jüstin birazdan onun üstüne yün
...
ihtiyacı var; \VUgras{sehpanın} \textsuperscript{(33)} yanında durur.
...
yerlerinde, ve hava soğuk olmadığından \VUgras{şömine}
\textsuperscript{(49)} takımında hiçbir şey oynatılmamış. \VUgras{Kürek}
\textsuperscript{(50)}, \VUgras{maşa} \textsuperscript{(51)},
\VUgras{odun ayakları} \textsuperscript{(55)} ile \VUgras{kül perdesi}
\textsuperscript{(56)} temiz; \VUgras{ateş perdesi} \textsuperscript{(54)}
oynatılmamış ve \VUgras{odun sandığı} \textsuperscript{(52)}
\VUgras{çıralarla} \textsuperscript{(53)} dolu.
...
%%K t06-c2-01-1 p
1. --- Şimdi işte salon. Çok güzel bir \VUgras{oda}. Sağ köşedeki şömine
ince bir \VUgras{heykelcik} \textsuperscript{(1)} ile iki güzel \VUgras{vazoyla}
\textsuperscript{(3)} süslü, ve kadifeden bir \VUgras{saçakla}
\textsuperscript{(2)} (*) örtülü.

%%K t06-c2-02-1 p
2. --- Şöminenin kıvılcımları halıyı tutuşturmasın diye, önüne bakırdan bir
\VUgras{ateş parmaklığı} \textsuperscript{(4)} konmuş.
...
%%K t06-c2-04-1 p
4. --- Pencerede \VUgras{tül perdeler} \textsuperscript{(6)} var, ki
\VUgras{kordonlar} \textsuperscript{(8)} onları bağlı tutar, ve o kordonlar
\VUgras{çengellere} \textsuperscript{(7)} takılı; üstlerinde de kalın kumaş
...
yeşil bir \VUgras{bitki} \textsuperscript{(10)} var, görkemli bir palmiye,
ki yaprakları \VUgras{gaz lambasına} \textsuperscript{(12)} neredeyse erişir.

%%K t06-c2-06-1 p
6. --- \VUgras{Abajuru} \textsuperscript{(13)} Marya yapmış,
...
oturmuş bir parça çalışıyor. Çok beceriklidir ve çok düzenli, ki
...
gemlenmeyen bir \VUgras{oğlan} \textsuperscript{(20)}. Çok yükseğe konmuş
...
\VUgras{hanım} \textsuperscript{(22)}. Anne \VUgras{kanepede}
...
akrabanın \VUgras{portresi} \textsuperscript{(29)} var. Masada duran
\VUgras{albümde} \textsuperscript{(32)} ailenin geri kalanının
\VUgras{fotoğrafları} \textsuperscript{(33)} toplanmış. Çocuklar biraz önce
...
\VUgras{duvara} \textsuperscript{(42)} asılı, tavandaki \VUgras{avizeyle}
\textsuperscript{(38)} aydınlık, ki \VUgras{elektrik lambaları}
\textsuperscript{(39)} akşamları öyle sevinçli parlar, bu salon çok hoş
...
%%K t06-c3-01-1 p
1. --- Yemek çanı çalmış. Marya dışında bütün aile sofranın çevresinde
toplanmış. Yemek odası iyi bir toprak \VUgras{sobayla} \textsuperscript{(1)} hoş bir
biçimde ısınmış, ki \VUgras{borusu} \textsuperscript{(2)} ince.

%%K t06-c3-02-1 p
2. --- Bu odada eşya çok değil. Duvar boyunca, \VUgras{sehpanın}
\textsuperscript{(4)} üstünde, süslü küçük bir \VUgras{çeşme}
\textsuperscript{(3)} asılı. Yanında \VUgras{büfe} \textsuperscript{(5)}
var; üstüne soğuk yemekler, tatlılar ve şu sırada gerekmeyen takımlar
konur.
...
\textsuperscript{(21)} çakılmış. Kumaştan bir \VUgras{kapı perdesi}
...
\textsuperscript{(23)} üstüne şimdiden dizilmiş.

%%K t06-c3-06-1 p
6. --- Sofranın üstünde tavandan bir \VUgras{asma lamba} \textsuperscript{(26)}
sarkar; çok güçlü ışığı akşamları bütün yemek odasını doldurur.
...
verilmiş. Bu liste « otel » (No 13) ile « pazar » (No 15) adlı iki tabloda
tamamlanacak.}
...
\textsuperscript{(5)} kurulmuş. İyi bir \VUgras{kızartma}
...
\textsuperscript{(10)} birlikte yerde bırakılmış.

%%K t06-c4-03-1 p
3. --- Şöminenin üst yanı derli: \VUgras{fener} \textsuperscript{(11)},
\VUgras{kibritlik} \textsuperscript{(13)}, ki içinde \VUgras{kibritler}
\textsuperscript{(12)} var, \VUgras{şamdan} \textsuperscript{(14)} ve
\VUgras{el şamdanı} \textsuperscript{(15)}, \VUgras{mumuyla}
\textsuperscript{(16)} birlikte --- hepsi yerinde. Ama büyük
\VUgras{kömür sepeti} \textsuperscript{(18)}, \VUgras{kömürle}
\textsuperscript{(17)} dolu, ki \VUgras{aşçı kadın} \textsuperscript{(23)} az
önce bodrumdan getirmiş, mutfağın tam ortasında kalıvermiş.
...
akşam çayı için yapmış. Ocağın üstünde \VUgras{kepçe} \textsuperscript{(21)}
ile \VUgras{kevgir} \textsuperscript{(22)} asılı.
...
çok temiz. Bakırdan güzel \VUgras{tencereler} \textsuperscript{(26)},
...
\textsuperscript{(35)} bir köşede. Aşçı kadın az önce \VUgras{kütüğü}
\textsuperscript{(36)} kullanmış; onu pencerenin yanında bırakmış.

%%K t06-c4-09-1 p
9. --- Bir \VUgras{el havlusu} \textsuperscript{(37)} duvarda asılı,
...
\VUgras{kazan} \textsuperscript{(46)} var. \VUgras{Kızartma tavası}
\textsuperscript{(47)} yanı başında asılı.

%%K t06-c4-10-1 p
10. --- Bu köşede yalnız bakırdan \VUgras{musluk} \textsuperscript{(48)}
parıldar. \VUgras{Eviye} \textsuperscript{(49)}, ki üstünde büyük
\VUgras{testi} \textsuperscript{(50)} durur, küçük dolabıyla birlikte çok işe
yarayacak; orada \VUgras{sirke fıçısı} \textsuperscript{(51)},
...
\textsuperscript{(57)} üstünde durur, herhâlde o dolabın.

%%K t06-c4-12-1 p
12. --- Aşçı kadının ocağı eksik değil, çünkü işte masanın köşesinde bir
...
olduğunu gösterir. Bu su herhâlde kahve için, çünkü masanın öteki ucunda
işte \VUgras{kahve kabı} \textsuperscript{(64)} ile \VUgras{kahve değirmeni}
\textsuperscript{(63)}.

%%K t06-c4-13-1 p
13. --- Gaz ocağı \VUgras{gaz musluğuna} \textsuperscript{(62)} bağlı, uzun
...
banyonun döşenişini görmek. Uzun sürmeyecek, çünkü büyük değil, ve hemen
göreceğiz ki \VUgras{banyo küvetinin} \textsuperscript{(1)} yanında iyi bir
\VUgras{su ısıtıcısı} \textsuperscript{(2)} var, \VUgras{sabunluk}
\textsuperscript{(3)} yıkananın elinin erişeceği yerde, ve
\VUgras{havlulukla} \textsuperscript{(5)} \VUgras{havluları}
\textsuperscript{(4)} kurutmak kolay oluyor.

%%K t06-c5-02-1 p
2. --- Bu odanın duvarları parlak \VUgras{fayanslarla} \textsuperscript{(6)}
kaplı; bu da bir \VUgras{duş} \textsuperscript{(7)} koymayı olanaklı kıldı,
