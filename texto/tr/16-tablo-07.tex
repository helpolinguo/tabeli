...
\textsuperscript{(11)} bindik; ama hava pek soğuktu, ve böyle rahatsız bir
...
müşterileri hoşnutsuzdur. \VUgras{Usturaları} hep kertiklidir ve
\VUgras{makası} hiçbir zaman doğru kesmez. Ama köyün tek berberi o olduğundan,
insanların ona tıraş olmaktan ve saç kestirmekten başka çaresi yoktur. Üstelik
cimri ve serttir.

%%K t07-c1-08-1 p
8. --- Bereket öteki \VUgras{komşular} onun gibi değildir. Söz gelişi
\VUgras{arabacı} \textsuperscript{(9)} iyi bir adamdır, çalışkan ve
yardımsever. Arabayı ona onarmaya vermek bir zevktir. İşi her zaman temizdir.
...
%%K t07-c1-09-2 p
Babam ona ailesini sordu. « Hepsi sağ salim. Torunum \VUgras{okuldadır}
\textsuperscript{(12)}. \VUgras{Öğretmeni} \textsuperscript{(13)} ondan pek
hoşnuttur; iyi bir \VUgras{öğrencidir} \textsuperscript{(14)}. Şu yaramaz
...
yapılacaktı, çünkü \VUgras{köy konağındaki} pek küçük gelmişti. Bu kolay
olurdu, çünkü \VUgras{değirmencinin} bahçesinin bir bölümünü satın almak
yeterdi. Zavallı için bu pek iyi olurdu. Soğuklar bastıralı, \VUgras{değirmenin}
...
gördünüz mü? Kar örtüsünün altında pek görünüşlü durur.
...
belasıdır. \VUgras{Kayışı} \textsuperscript{(29)} ile \VUgras{püsküllü
...
\VUgras{satıcı kadından} alıyorlardı, ki pek ince \VUgras{şalı}
...
otunu biçmiştir, kurutucular \VUgras{kuru otu} \textsuperscript{(10)}
\VUgras{tırmıklarla} \textsuperscript{(12)} ve dirgenlerle altüst edip
kurutmuştur, ve şimdi dönüyorlar.

%%K t07-c2-03-2 p
Kimi öküzlerin çektiği ağır arabanın önünde yürüyor, omzunda aletiyle.
Ötekiler, daha tembel, kokulu kuru otun üstüne rahatça serilmiştir.
...
\VUgras{Erik ağaçları} \textsuperscript{(15)} çiçek yüklüdür, ve iyi gübrelenmiş
...
%%K t07-c2-05-1 p
5. --- \VUgras{Ahırın} \textsuperscript{(19)} kapıları açıktır, ve yemlik
ile \VUgras{yataklık saman} \textsuperscript{(23)} görünür, ki
\VUgras{kısrağındır} \textsuperscript{(21)}; kısrağı \VUgras{seyis}
\textsuperscript{(20)} az önce çözmüştür. \VUgras{Tay} \textsuperscript{(22)}, uzun bacakları
...
içmeye gidiyor, ki onların çeşmesidir. \VUgras{Buzağı}
...
%%K t07-c2-07-1 p
7. --- Herkes iş başındadır. \VUgras{Hizmetçi kız} \textsuperscript{(32)}
...
\VUgras{kulübenin} \textsuperscript{(38)} yanında bırakılmıştır, ki
\VUgras{köpeğindir} \textsuperscript{(37)}.
...
%%K t07-c2-13-1 p
13. --- Bütün \VUgras{süthane} \textsuperscript{(59)} pek temiz durur,
...
yiyorlar. Jeni tavşanlarını pek sever, ve her gün, kümesten taze
