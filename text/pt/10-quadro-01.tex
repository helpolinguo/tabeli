...
%
%  L'ORTHOGRAPHE EST CELLE DE L'ACCORD DE 1990.
%
%  ET LE VOCABULAIRE EST CELUI DU PORTUGAL, ce que cet en-tete a
%  longtemps nie : il annoncait le Bresil et « trem » plutot que
%  « comboio ». Or la colonne ecrit « comboio » sept fois, « casa de
%  banho » quatre, « res do chao » quatre, « talho » trois,
%  « pequeno-almoco » deux, « paragem », « criada », « retrete » — elle
%  est europeenne de bout en bout, et elle l'a toujours ete. On corrige
%  donc la consigne sur le texte, et non l'inverse : c'est le texte qui
%  est la mesure.
%
%  Un seul mot suivait la consigne : « Antonio » portait l'accent
%  circonflexe bresilien au milieu d'une colonne portugaise. Remis en
%  « Antonio » a accent aigu. Le portugais du Bresil se lit dans la
%  variante pt-BR, qui se calque sur cette colonne-ci.
%
...
%%K t01-10-1 p
10. --- Na mesa ao lado estão \VUgras{Luís, António} e \VUgras{Paulo}. Luís
recita a sua \VUgras{lição} \textsuperscript{(22)} e responde às \VUgras{perguntas}
do professor. António \textsuperscript{(21)} está muito distraído; às vezes o
