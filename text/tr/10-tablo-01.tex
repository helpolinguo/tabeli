...
%  qui l'annonce.
%
%  ET L'INTENSIF ETAIT A L'ENVERS. Cette colonne disait « pek » 117
%  fois et « cok » 52. En turc d'aujourd'hui c'est l'inverse : « cok »
%  est l'intensif de tout le monde, « pek » est marque — plus vieux,
%  plus affectueux, et surtout plus frequent au negatif (« pek iyi
%  degil »). Cent six « pek » deviennent « cok » ; le rapport passe a
%  142 contre 27.
%
%  MAIS « pek cok », « pek az » ET « pek cogu » SONT DES LOCUTIONS :
%  « pek cok » veut dire « beaucoup », non « tres beaucoup ». Le
%  premier passage les a cassees en « cok cok » seize fois, parce que
%  le garde-fou testait le mot suivant sans oter l'espace qui le
%  precedait. Remises. Une locution figee ne se balaie pas comme un
%  mot.
%
...
geniş bir \VUgras{pencere}, iki \VUgras{vasistas} \textsuperscript{(78)} ve bir
...
%%K t01-12-1 p
12. --- Öğretmenin solunda, ikinci sıranın öğrencileri çok küçük. İlki,
...
Sonuncusu iyi çalışır, ama \VUgras{kılığı} çok pasaklı.
...
\VUgras{Öğretmen} \textsuperscript{(60)} çok sabırlı; öğrencilerin
...
%%K t01-16-1 p
16. --- \VUgras{Müzik odası} çok ilgi çekici. Orada \VUgras{müzik} okumayı,
