...
%%K t05-01-1 p
\textsc{Jan}. --- Amca, bir \VUgras{evin} nasıl yapıldığını çok bilmek
isterim.
...
%%K t05-01-4 p
\textsc{Amca}. --- \VUgras{Mimar} \textsuperscript{(75)}; çok temiz bir çizim
yaptı, o da kabul edildi, ve \VUgras{müteahhit} \textsuperscript{(77)} işe
başladı.

%%K t05-01-5 p
\textsc{Jan}. --- Peki müteahhit kim?
...
%%K t05-01-9 p
\textsc{Bay Ru}. --- Çok iyiyim, teşekkür ederim. Günaydın Jan; oğlan ne kadar
büyümüş!

%%K t05-01-10 p
\textsc{Amca}. --- Gerçekten, tam küçük bir adam oldu. Çok ağırbaşlı;
...
anlatayım, çünkü öğrenmek isteyen çocuklardan çok hoşlanırım.

%%K t05-01-12 p
Elinde \VUgras{küreği} \textsuperscript{(82)} olan şu işçiyi görüyor musun:
o \VUgras{kazıcı} \textsuperscript{(81)}. Su borusunu döşemek için bir
...
pencere, bir \VUgras{kapı} \textsuperscript{(4)} ve bir merdiven var.
...
%%K t05-01-15 p
\textsc{Bay Löblan}. --- Onun evdeki işi artık bitmiş. Şurada
\VUgras{ahırın} \textsuperscript{(54)} yanında, \VUgras{iskelesine}
...
var. Ama bu adları aklında tutamazsın.
...
%%K t05-01-18 p
\textsc{Amca}. --- Aferin, çok güzel. Ama söyle bakalım Jan, bir ev yapmak
için ne gerekir?
...
\textsuperscript{(71)} içinde; bir \VUgras{duvarcı yardımcısı}
...
%%K t05-01-23 p
\textsc{Jan}. --- O \VUgras{çatıcı} \textsuperscript{(118)}.
...
işçiler dülger. Biri küçük bir kirişi tutuyor, öteki de
\VUgras{baltasıyla} \textsuperscript{(116)} bir takoz yontuyor.
\VUgras{Bacanın} \textsuperscript{(41)} yanındaki çatıcı.
...
\VUgras{çinkodan} \textsuperscript{(24)}.
...
çalışıyor. Bir \VUgras{testeresi} \textsuperscript{(94)} var,
...
%%K t05-01-33 p
\textsc{Jan}. --- Vay, öyleyse dülger olmak duvarcı olmaktan da eğlenceli.
...
%%K t05-01-36 p
\textsc{Bay Löblan}. --- O \VUgras{boyacı} \textsuperscript{(102)}.
...
\textsuperscript{(106)} çıkmış \VUgras{balkonda} \textsuperscript{(28)},
bir \VUgras{perde} \textsuperscript{(29)} takıyor.

%%K t05-01-39 p
Büyük pencerenin yanında duran işçi \VUgras{camcı}
\textsuperscript{(96)}. \VUgras{Camları} \textsuperscript{(18)}
\VUgras{macunla} \textsuperscript{(73)} tutturur. Bodrumun kapısı yanında diz
çökmüş öteki işçi \VUgras{çilingir} \textsuperscript{(97)}. Bir
...
vuran adam da mı çilingir?

%%K t05-01-41 p
\textsc{Bay Löblan}. --- Doğrusunu söylemek gerekirse o \VUgras{demirci}
\textsuperscript{(125)}. \VUgras{Demir işlerini} \textsuperscript{(67)}
dövüyor, \VUgras{elektrikçi} \textsuperscript{(124)} için, ki
\VUgras{araba barakasının} \textsuperscript{(51)} çatısında. Bir \VUgras{ocağı}
\textsuperscript{(126)}, bir \VUgras{örsü} \textsuperscript{(127)} ve bir
\VUgras{kerpeteni} \textsuperscript{(128)} var.
...
\VUgras{Beliyle} \textsuperscript{(131)} toprağı kazmış, tohum ekiyor ve
...
\textsuperscript{(14)} çıkarız, ki \VUgras{giriş merdiveninin}
\textsuperscript{(9)}, sonra \VUgras{eşiği} \textsuperscript{(10)} geçeriz,
ki \VUgras{sokak kapısının} \textsuperscript{(8)}, ve işte \VUgras{merdivenin}
\textsuperscript{(13)} altındayız.

%%K t05-01-50 p
\textsc{Jan}. --- Burası koridor.

%%K t05-01-51 p
\textsc{Mimar}. --- Hayır, burası \VUgras{antre} \textsuperscript{(12)}.
\VUgras{Koridor} \textsuperscript{(a)} dipte. Sağda işte \VUgras{salon}
...
\VUgras{camlı kapısıyla} \textsuperscript{(25)} birlikte, salonun yanında.

%%K t05-01-52 p
Şimdi merdiveni çıkacağız. \VUgras{Tırabzana} \textsuperscript{(15)} tutun ve
basamakları say. On dört tane. İşte \VUgras{sahanlık}
...
%%K t05-01-55 p
\textsc{Mimar}. --- İkinci kat yok. Çatının altında yalnız
\VUgras{tavan araları} \textsuperscript{(33)} ile depo \textsuperscript{(34)}
var. Turumuz bitti, artık inebiliriz.

%%K t05-01-56 p
\textsc{Jan}. --- Teşekkür ederim efendim, çok ilgi çekiciydi. Gördüğüm her
