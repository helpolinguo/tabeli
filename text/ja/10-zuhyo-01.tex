...
%  Midi, et le s final s'y entend, comme dans Chaban-Delmas : le
%  katakana doit donc le rendre — デルマス, non デルマ.
%
...
%
%  LA COLONNE ETAIT ECRITE EN 1926, ET C'ETAIT LA FAUTE. Aucune autre
%  ne s'etait laissee prendre a ce point : le japonais avait pris au
%  fac-simile non pas une tournure, mais un LEXIQUE — celui d'avant
%  guerre, avec ses ateji. 硝子 pour ガラス, 珈琲 pour コーヒー,
%  燐寸 pour マッチ, 天鵞絨 pour ビロード, 麦酒 pour ビール,
%  瓦斯 pour ガス, 蒲団 pour 布団, 驢馬 pour ロバ, 押釦 pour
%  押しボタン. Cent seize mots en tout.
%
%  ON MODERNISE LA LANGUE, JAMAIS LES CHOSES, et c'est ici qu'il faut
%  savoir de quel cote tombe chaque mot. 汽船 reste : le bateau de
%  1926 marche bien a la vapeur, et 汽船 est encore le mot du
%  japonais d'aujourd'hui pour cette chose-la. 蓄音機 reste, pour la
%  meme raison. 停車場, en revanche, s'en va : la gare est toujours
%  une gare, mais on l'appelle 駅 depuis longtemps. 寝台 devient
%  ベッド dans la chambre — et 寝台車 ne bouge pas, parce que c'est
%  le nom actuel du wagon-lit.
%
%  ET DEUX MOTS QUI SONT DATES AUTREMENT. 女中 et 料理女 nomment la
%  domestique et la cuisinieres par leur sexe ; en 2026 on ecrit
%  メイド et 料理人. Le fac-simile disait « la femme de chambre » et
%  « la cuisiniere » parce que le francais genre ses metiers ; le
%  japonais, lui, ne les genre pas, et n'a donc aucune raison de le
%  faire.
%
%  LA SYNTAXE, ELLE, N'AVAIT PAS VIEILLI. Le style である revient
%  deux cent soixante-seize fois : c'est le japonais expositif normal,
%  celui des manuels et des encyclopedies, et il ne bouge pas. Seuls
%  trois negatifs en ぬ et neuf renvois « ...を見よ » etaient de
%  l'ecrit ancien ; ils deviennent ...ない et ...を参照. Douze
%  corrections de tournure, contre cent seize de vocabulaire.
%
...
%%K t01-02-1 p
2. --- 教壇の左にはガラス戸のついた\VUgras{戸棚} \textsuperscript{(15)} が立って
...
%%K t01-05-1 p
5. --- 教室はたいそう広く、たいそう明るい。奥には二つの\VUgras{換気窓}
...
作らなければならないのか。ラテン語の主格を取って、こう言おう。
