...
知っている。では、どう飾りつけたかを参照う。まず見に行くのは次の部屋である。
...
%%K t06-c1-01-1 p
1. --- 我々は折わるく来てしまった。メイドが\VUgras{部屋}を片づけている最中で
ある。
...
%%K t06-c1-06-1 p
6. --- \VUgras{メイド} \textsuperscript{(16)} が\VUgras{ベッド} \textsuperscript{(17)} を
整えているうちに、その部分部分を見てゆこう。\VUgras{ベッドの枠}
\textsuperscript{(20)} の上によい\VUgras{ばね布団} \textsuperscript{(21)} があり、
ジュスチーヌはやがてその上に毛の\VUgras{布団} \textsuperscript{(22)} を敷くので
ある。それから椅子の上の二枚の\VUgras{敷布} \textsuperscript{(23)} と
\VUgras{毛布} \textsuperscript{(24)} を取る。次に\VUgras{長枕} \textsuperscript{(25)}
と\VUgras{枕} \textsuperscript{(26)} をベッドの頭に置く。それらはいま\VUgras{羽根布団}
\textsuperscript{(27)} とともに\VUgras{ベッド前の敷物} \textsuperscript{(32)} の上に
ある。\VUgras{ベッドのカーテン} \textsuperscript{(19)} と\VUgras{天蓋} \textsuperscript{(18)}
を羽根の払子で払えば、仕事は半ばできる。

%%K t06-c1-07-1 p
7. --- それから\VUgras{ベッド脇の台} \textsuperscript{(28)} を少し片づけ、
...
%%K t06-c1-08-1 p
8. --- \VUgras{針箱} \textsuperscript{(34)} は\VUgras{腰掛け} \textsuperscript{(33)} の
...
\VUgras{ガラス瓶} \textsuperscript{(42)} の水を替える。\VUgras{砂糖壺}
...
その\VUgras{座布団} \textsuperscript{(48)} はもとの場所にあり、寒くもないので
...
が二つ飾ってあり、ビロードの\VUgras{暖炉のカーテン} \textsuperscript{(2)} (*) が垂れて
いる。
...
%%K t06-c2-04-1 p
4. --- 窓には\VUgras{レースのカーテン} \textsuperscript{(6)} が掛かり、\VUgras{括り紐}
\textsuperscript{(8)} でまとめてある。その紐は\VUgras{掛鉤} \textsuperscript{(7)} に
掛かっている。それに厚い布のカーテンがあり、上に\VUgras{カーテンの上飾り} \textsuperscript{(9)} が
ついている。
...
いる。\VUgras{ピアノの椅子} \textsuperscript{(16)} にまっすぐ坐って曲を稽古して
...
\VUgras{肖像} \textsuperscript{(29)} が入っている。卓の上に開いた\VUgras{アルバム}
...
\textsuperscript{(40)} と、あれほど重宝な\VUgras{電気の呼び鈴} \textsuperscript{(41)}
とが、これをすっかり快いものにしている。
...
%%K t06-c3-02-1 p
2. --- この部屋には家具が多くない。壁沿いに、\VUgras{腰掛け} \textsuperscript{(4)}
...
が張ってある。布の\VUgras{戸口のカーテン} \textsuperscript{(22)} がベランダへ通じる戸を
よく塞いでいる。食後に一家はそこへコーヒーを飲みに行く。\VUgras{茶碗}
...
%%K t06-c3-07-1 p
7. --- では\VUgras{食卓} \textsuperscript{(27)} そのものを参照う。一家が入って
...
\textsuperscript{(30)} と水の\VUgras{ガラス瓶} \textsuperscript{(31)} もあった。
...
すでに名を挙げた料理を運び、最後に\VUgras{菓子}のあと、主人たちがベランダへ
...
\VUgras{コンロ} \textsuperscript{(1)} の前では\VUgras{火} \textsuperscript{(3)} がぱちぱち
...
\VUgras{マッチ入れ} \textsuperscript{(13)} と中の\VUgras{マッチ} \textsuperscript{(12)}、
...
いっぱいに入れて --- その石炭は\VUgras{料理人} \textsuperscript{(23)} がいま穴倉
から取ってきたのである --- 台所の真中に置きっぱなしである。

%%K t06-c4-04-1 p
4. --- じつのところ、この気の毒な女は急がねばならない。昼食を間に合わせる
ためである。いまは\VUgras{煮炊きのコンロ} \textsuperscript{(19)} の前で\VUgras{汁}
\textsuperscript{(24)} をかき回している。焦がしてはならないのである。

%%K t06-c4-05-1 p
5. --- \VUgras{天火} \textsuperscript{(20)} ではケーキが焼けている。子供たちの
おやつに作ったものである。コンロの上には\VUgras{柄杓} \textsuperscript{(21)} と
...
は隅にある。料理人はいま\VUgras{俎の台} \textsuperscript{(36)} を使ったばかりで、
窓のそばに置きっぱなしにしている。
...
%%K t06-c4-12-1 p
12. --- 料理人にコンロが足りないことはない。こちらの卓の隅に\VUgras{ガスコンロ}
\textsuperscript{(59)} があり、その上の小さな鍋で湯が沸いている。立ちのぼる
\VUgras{湯気} \textsuperscript{(60)} が、もう煮立っているに違いないと教えている。
この湯はおそらくコーヒーのためであろう。卓の反対の端に\VUgras{コーヒーポット}
\textsuperscript{(64)} と\VUgras{コーヒーミル} \textsuperscript{(63)} があるからである。

%%K t06-c4-13-1 p
13. --- ガスコンロは\VUgras{ガスの口} \textsuperscript{(62)} につないである。長い
\VUgras{ゴムの管} \textsuperscript{(61)} を使ってである。

%%K t06-c4-14-1 p
14. --- 料理人を手伝いに来る\VUgras{通いの女} \textsuperscript{(66)} が夕食の
