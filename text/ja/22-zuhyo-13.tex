...
%%K t13-noto-1 noto
\VUnotes{143.2mm}{%
\textit{\VUgras{(*) 部屋の細目については図表第 6 号を参照。}}%
}
...
に心づけをやった。彼は\VUgras{手押し車} \textsuperscript{(25)} で駅から私の
...
\textsuperscript{(36)} が一人、\VUgras{カメラ} \textsuperscript{(38)} を肩から斜めに
...
のあいだで居眠りをしていた。若い\VUgras{洗濯屋} \textsuperscript{(42)} は洗濯物の
...
\VUgras{ビスケット}である。さらにサン・テミリオンのよい\VUgras{ワイン}を一本添えた。
