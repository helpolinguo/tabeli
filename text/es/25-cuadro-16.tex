...
una \VUgras{coraza} \textsuperscript{(3)} y una \VUgras{pistola} \textsuperscript{(4)}. Todo
eso
...
hermosísimos \VUgras{calzones} \textsuperscript{(63)}. Cerca, una
\VUgras{dependienta} \textsuperscript{(61)} ayudaba a una \VUgras{clienta}
...
\textsuperscript{(100)} para un \VUgras{cliente} \textsuperscript{(99)}.
