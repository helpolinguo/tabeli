...
%  note parle.
%
%  DEUX TOURNURES OTEES EN 2026. Le catalan avait pris au fac-simile
%  francais son « voici » — vingt et une fois « heus aqui » — et son
%  « car » explicatif — dix fois, dont aucune n'etait fautive et
%  toutes etaient litteraires. Les deux existent en catalan ; aucune
%  des deux n'appartient a la langue qu'on ecrit aujourd'hui pour
%  commenter une planche murale.
%
%  « heus aqui » s'en va cas par cas, jamais par une formule unique :
%  « Al seu costat hi ha la lletera », « Comencem pel front »,
%  « Aquest es el boto del timbre », « passen dos soldats de permis ».
%  Le francais ne disait pas non plus la meme chose vingt et une fois.
%  « car » devient « perque », et « ja que » quand « perque » aurait
%  suivi de trop pres un autre « perque ».
%
%  L'INTERTITRE « El barat i el car » RESTE : ce « car » est
%  l'adjectif, non la conjonction. Un balayage sur le mot seul les
%  confond ; il faut lire les dix occurrences.
%
...
ampla amb dos \VUgras{finestrons de ventilació} \textsuperscript{(78)} i una \VUgras{porta
