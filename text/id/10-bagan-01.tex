...
%
%  DEUX CORRECTIONS, ECRITES APRES COUP : IL Y A CINQ COUCHES, ET NON
%  TROIS. Ce compte a du etre repris DEUX FOIS, et c'est la mesure de
%  ce qu'un en-tete annonce trop tot vaut.
%
%  LA SECONDE CORRECTION, APRES LE TABLEAU 11 : IL MANQUAIT LE
%  PORTUGAIS, et c'est la couche la plus ancienne des cinq. Malacca
%  tombe en 1511, un siecle avant les Hollandais. En tirant le fil du
%  violon — biola, de viola —, on trouve que cette colonne emploie
%  depuis le tableau 1 vingt-trois mots portugais, cent soixante-deux
%  fois en tout : meja la table, jendela la fenetre, gereja l'eglise,
%  sepatu la chaussure, minggu le dimanche, keju le fromage, bendera
%  le drapeau, mentega le beurre, garpu la fourchette, kemeja la
%  chemise, lemari l'armoire, bangku le banc, boneka la poupee, roda
%  la roue, tenda la tente, pesta la fete, dansa la danse, nona la
%  demoiselle, beranda la veranda, pita le ruban, bola la balle,
%  kereta la voiture, sekolah l'ecole. Aucun locuteur ne les sent
%  etrangers : une couche se remarque tant qu'elle detonne, et
%  celle-ci ne detonne plus depuis quatre cents ans.
%
%  ET LA PREUVE ETAIT DEJA ECRITE DANS CETTE COLONNE : l'en-tete du
%  tableau 4 disait, a propos de beranda, « qui lui vient du
%  portugais varanda ». Elle etait sous la main depuis six tableaux
%  et on n'en avait pas tire la consequence. Un compte ne se corrige
%  pas en comptant mieux, il se corrige en RELISANT ce qu'on a deja
%  ecrit.
%
%  LA PREMIERE CORRECTION, APRES LE TABLEAU 5 : IL MANQUAIT LE
%  HOKKIEN, apporte par les marchands et les
