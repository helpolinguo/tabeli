...
nutriment sa radunan sut la \VUgras{halla} \textsuperscript{(1)} dal \VUgras{martgà cuvert} u
en
...
ch'ha fermà ses \VUgras{char da liuraziun} \textsuperscript{(21)} chargià cun \VUgras{barigls
da
...
n'è gia betg pli la simpla e nunimpurtanta \VUgras{spezeria} \textsuperscript{(32)} d'ina
giada,
...
setgas} \textsuperscript{(65)} ed a las \VUgras{nuschellas} \textsuperscript{(66)}. Ins chatta
en
quel magasin frais \VUgras{ovs} \textsuperscript{(67)} ed
\VUgras{olivas} \textsuperscript{(68)};
...
merteivla, perquai ch'il vegl \VUgras{spezier} \textsuperscript{(71)} sez al brascha cun la
pli
gronda premura.
...
mintga sort da \VUgras{charn}, \VUgras{charn da muntun} \textsuperscript{(90)}, \VUgras{charn
da
bov} \textsuperscript{(94)} u \VUgras{charn da vadè} \textsuperscript{(92)}, sco
\VUgras{cossas da
...
il \VUgras{polizist} \textsuperscript{(100)} senza cumpassiun las paupras \VUgras{colportadras
da
...
%%K t15-17-1 p
17. --- Il mat che venda \VUgras{agl} \textsuperscript{(101)} e \VUgras{tschagulas} sa fitg
bain
