...
%
%  CORRECTION, ECRITE APRES LE TABLEAU 2 : « daki » N'ETAIT PAS AUSSI
%  SUR QUE CETTE LIGNE LE DIT. La forme nue existe bien, redoublee et
%  liee : « daki-daki » veut dire « en detail », et le N.-B. du
%  tableau 2 l'emploie. La regle est donc resserree — elle ne s'ouvre
%  plus sur un mot qui touche un trait d'union — et sept formes sur
%  huit restaient exactes. Une liste de huit se paie une fois.
%
