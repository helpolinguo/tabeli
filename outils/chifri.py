...
#
#  LE PROBLEME. outils/chifri.npz tient dix modeles de chiffres tires
...
#  pour entrer seul dans numeri.json — la regle de la maison est
...
#  gravuri/manuali.json, par la meme porte que ce que l'oeil trouve
#  tout seul.
#
#  USAGE
#      python3 outils/chifri.py aprendar     # refait chifri-gris.npz
#      python3 outils/chifri.py proponar     # propose, et decoupe
#      python3 outils/chifri.py proponar t14-apar-1
#
#  La feuille de relecture sort dans gravuri/proponi.png, et les
#  places proposees dans gravuri/proponi.json — a recopier a la main
#  dans manuali.json, celles qu'on garde.
# ===================================================================
...
RACINE = N.RACINE
MODELES = RACINE / "outils" / "chifri-gris.npz"
PROPONI = RACINE / "gravuri" / "proponi.png"
PLACES = RACINE / "gravuri" / "proponi.json"
...
def moissonar():
    ...
    cat = json.loads((RACINE / "gravuri" / "numeri.json")
